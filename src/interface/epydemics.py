...
def fit_model(location, dataset='', model='contagion', start=1, end=None, x0=(0.1, 1), output=True, pretrain=False):
    fit = Fitter.fit_model(location, dataset, model, start, end, x0, pretrain)
