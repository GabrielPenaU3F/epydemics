...
epydemics.calculate_mtbi_inverse('Argentina', start=420, dataset='total_cases', formula='approx_conditional')

# DataManager.load_dataset('mapache_arg')
# epydemics.calculate_mtbi_inverse('Buenos Aires', start=420, dataset='nue_casosconf_diff', formula='approx_conditional')
