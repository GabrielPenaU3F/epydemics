...
points = []
alpha_1 = 0.4
print('\n Experiment 4.0: Ridge regression (\u03B1 = ' + str(alpha_1) + ') - Real MTBI = ' + str(round(real_mtbi, 4)) + '\n')
...
points = []
alpha_2 = 0.1
print('\n Experiment 4.1: Ridge regression (\u03B1 = ' + str(alpha_2) + ') - Real MTBI = ' + str(round(mtbis[199], 4)) + '\n')
...
points = []
alpha_3 = 0.01
print('\n Experiment 4.2: Ridge regression (\u03B1 = ' + str(alpha_3) + ') - Real MTBI = ' + str(round(mtbis[199], 4)) + '\n')
