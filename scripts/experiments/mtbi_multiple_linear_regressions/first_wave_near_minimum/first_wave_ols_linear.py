...
print('Experiment 3.1: Ordinary least squares - Real MTBI = ' + str(round(real_mtbi, 4)) + '\n')

# m = 30

points = []

reg = RegressionManager().linear_regression(mtbis_train, 30, 16, output='full', affine=False)
...
reg = RegressionManager().linear_regression(mtbis_train, 30, 8, output='full', affine=False)
prediction = round(reg.predict(), 4)
rel_err = float(str(format(100 * np.abs(prediction - real_mtbi)/real_mtbi, '.4f')))
...
reg = RegressionManager().linear_regression(mtbis_train, 30, 4, output='full', affine=False)
prediction = round(reg.predict(), 4)
rel_err = float(str(format(100 * np.abs(prediction - real_mtbi)/real_mtbi, '.4f')))
...
reg = RegressionManager().linear_regression(mtbis_train, 30, 2, output='full', affine=False)
prediction = round(reg.predict(), 4)
rel_err = float(str(format(100 * np.abs(prediction - real_mtbi)/real_mtbi, '.4f')))
...
reg = RegressionManager().linear_regression(mtbis_train, 15, 16, output='full', affine=False)
prediction = round(reg.predict(), 4)
rel_err = float(str(format(100 * np.abs(prediction - real_mtbi)/real_mtbi, '.4f')))
...
reg = RegressionManager().linear_regression(mtbis_train, 7, 16, output='full', affine=False)
prediction = round(reg.predict(), 4)
rel_err = float(str(format(100 * np.abs(prediction - real_mtbi)/real_mtbi, '.4f')))
