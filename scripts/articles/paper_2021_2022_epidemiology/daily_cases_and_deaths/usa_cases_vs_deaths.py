...
filtered_cases = apply_ma_filter(cases_data, 36, 7)
filtered_deaths = apply_ma_filter(deaths_data, 16, 7)
...
filename = 'E:/Universidad/Investigación/Coronavirus/Python/script_outputs/usa_filtered_cases_vs_deaths.pdf'
