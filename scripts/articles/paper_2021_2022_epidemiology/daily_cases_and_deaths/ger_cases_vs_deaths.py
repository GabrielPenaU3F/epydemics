...
filtered_cases = apply_ma_filter(cases_data, 60, 7)
filtered_deaths = apply_ma_filter(deaths_data, 50, 7)
...
filename = 'E:/Universidad/Investigación/Coronavirus/Python/script_outputs/ger_filtered_cases_vs_deaths.pdf'
