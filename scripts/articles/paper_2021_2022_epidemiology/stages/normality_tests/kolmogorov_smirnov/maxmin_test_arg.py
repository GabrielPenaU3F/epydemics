...
# Max
statistic, pv = stats.kstest(arg_max_errors, stats.norm.cdf)
print('------- Argentina -------')
print('Curve of the maximums:')
print("Kolmogorov-Smirnov statistic: " + '{:g}'.format(statistic))
...
# Min
statistic, pv = stats.kstest(arg_min_errors, stats.norm.cdf)
print('------- Argentina -------')
print('Curve of the maximums:')
print("Kolmogorov-Smirnov statistic: " + '{:g}'.format(statistic))
print('P-value: ' + '{:g}'.format(pv))
