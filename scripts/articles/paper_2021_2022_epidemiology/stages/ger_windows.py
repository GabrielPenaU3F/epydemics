...
mtbi_unit = 'sec'
filename = 'E:/Universidad/Investigación/Coronavirus/Python/script_outputs/ger_avg_mtbi_blue.pdf'
...
axes.plot(x, avg_mtbi, linewidth=2,  color='#0000A1', label='MTBI (averaged)')
axes.set_ylabel(ylabel, fontsize=32, labelpad=15)
...
axes.fill_between(x, lower_bound, upper_bound, facecolor='#4A8BC7', alpha=0.3, label='Standard deviation')
